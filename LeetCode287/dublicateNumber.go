...
func main() {
	var numbers = [5]int{8, 2, 1, 9, 9}
	fmt.Println("The duplicate number is:", findDuplicate1(numbers))
	fmt.Println("The duplicate number is:", findDuplicate2(numbers))
}
...
func findDuplicate1(nums [5]int) int {
...
func findDuplicate2(nums [5]int) int {
	var duplicateNumber int
